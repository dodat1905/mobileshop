...
ActiveRecord::Schema.define(version: 20180403162659) do
  ...
  create_table "item_photos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
  ...
  create_table "line_items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    t.bigint "product_id"
    t.bigint "cart_id"
